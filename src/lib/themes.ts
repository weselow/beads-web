...
export const THEMES: ThemeDefinition[] = [
  ...
  },
  {
    ...
    description: 'Official light Catppuccin palette',
    mode: 'light',
    layout: 'standard',
    headerVariant: 'standard',
    preview: { bg: '#eff1f5', surface: '#e6e9ef', text: '#4c4f69', accent: '#1e66f5' },
  },
  {
    id: 'catppuccin-frappe',
    name: 'Catppuccin Frappe',
    description: 'Muted dark Catppuccin palette',
    mode: 'dark',
    layout: 'standard',
    headerVariant: 'standard',
    preview: { bg: '#303446', surface: '#414559', text: '#c6d0f5', accent: '#8caaee' },
  },
  {
    id: 'catppuccin-macchiato',
    name: 'Catppuccin Macchiato',
    description: 'Medium-contrast Catppuccin palette',
    mode: 'dark',
    layout: 'standard',
    headerVariant: 'standard',
    preview: { bg: '#24273a', surface: '#363a4f', text: '#cad3f5', accent: '#8aadf4' },
  },
  {
    id: 'catppuccin-mocha',
    name: 'Catppuccin Mocha',
    description: 'Original dark Catppuccin palette',
    mode: 'dark',
    layout: 'standard',
    headerVariant: 'standard',
    preview: { bg: '#1e1e2e', surface: '#313244', text: '#cdd6f4', accent: '#89b4fa' },
  },
  {
    id: 'neo-brutalist',
    name: 'Neo-Brutalist',
